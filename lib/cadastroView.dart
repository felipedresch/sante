...
class _CadastroViewState extends State<CadastroView> {
  ...
  final _telefoneKey = GlobalKey<FormState>();
  final TextEditingController _telefoneController = TextEditingController();
  final _emailKey = GlobalKey<FormState>();
  final TextEditingController _emailController = TextEditingController();
  final _dataNascimentoKey = GlobalKey<FormState>();
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
                  ...
                  onPressed: () async {
                    ...
                    setState(() {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text("Cadastro Excluído!")));
                    });
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              // FutureBuilder(
              //     future: clienteRepository.recuperarConsultas(),
              //     builder: (BuildContext context,
              //         AsyncSnapshot<List<Sessao>> snapshot) {
              //       if (snapshot.hasData) {
              ...
              //                 title: Text(snapshot.data![position].data),
              //                 //(snapshot.data![position].queixa.length < 50)
              //                 //? int limite = snapshot.data![position].queixa.length
              //                 //: int limite = 50
              //                 subtitle: Text(snapshot.data![position].queixa
              //                     .substring(0, 50)),
              //               );
              //             });
              //       } else {
              //         return const Text("Não há consultas");
              //       }
              //     }),
              //FAZER A LISTA/HISTORICO DAS SESSOES COM A DATA E O NOME + BOTAO DE EXPANDIR QUE LEVA PRA PAGINA DE VISUALIZACAO DE CONSULTA
